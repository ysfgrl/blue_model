...
class _FJSONItemState extends State<FJSONItem> {
  ...
  void subItemMenuEvent(FJSONMenuOptions selectedItem, dynamic key, bool toParent, Map<String, dynamic>? val) {
    if(!toParent) {
      switch (selectedItem) {
    ...
    widget.menuEvent(selectedItem, "${widget.itemKey}.$key", true,  val);
  }
  void menuEvent(FJSONMenuOptions selectedItem) {
    switch(selectedItem){
      case FJSONMenuOptions.delete:
        widget.menuEvent(selectedItem, widget.itemKey, false, null);
        break;
      case FJSONMenuOptions.download:
        break;
      case FJSONMenuOptions.copy:
        const encoder = JsonEncoder.withIndent('  ');
        Clipboard.setData(ClipboardData(text: encoder.convert(widget.data))).then((_) {
      ...
      case FJSONMenuOptions.string:
        ...
        widget.menuEvent(selectedItem, widget.itemKey, true, null);
        break;
