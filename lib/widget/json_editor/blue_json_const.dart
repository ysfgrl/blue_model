...
enum FJSONMenuOptions { map, list, string, number, bool,  delete, download, copy }
...
typedef FJSONMenuEvent = void Function(FJSONMenuOptions options, dynamic key, bool toParent, Map<String, dynamic>? value);
typedef FJSONMenuEventCallback = void Function(FJSONMenuOptions options, dynamic key, Map<String, dynamic>? value);
