...
part 'blue_json_const.dart';
part 'blue_json_item.dart';
part 'blue_json_fields.dart';
part 'blue_json_menu.dart';
part 'blue_json_controller.dart';
      ...
      child: Consumer<FJSONNotifier>(
        builder: (context, state, child) {
          return FJSONItem(
            ...
            menuEvent: (options, key, toParent, val) {
              if(widget.menuEvent != null) widget.menuEvent!(options, key, val);
            },
